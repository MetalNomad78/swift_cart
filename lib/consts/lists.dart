...
const categoriesList=[womenDress,menclothing,compAccess,automobile,kidstoys,sports,jewellery,cellphone,furniture];
const categoriesImages=[imgFc1,imgFc2,imgFc3,imgFc4,imgFc5,imgFc6,imgFc7,imgFc8,imgFc9];

const itemDetails=[video,reviews,privacypolicy,returnPolicy,supportPolicy];
